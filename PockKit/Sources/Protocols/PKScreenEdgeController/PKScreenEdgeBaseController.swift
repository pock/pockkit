//
//  PKScreenEdgeBaseController.swift
//  PockKit
//
...
/// A controller that can handle mouse and dragging events.
open class PKScreenEdgeBaseController: NSObject, PKScreenEdgeMouseDelegate {
